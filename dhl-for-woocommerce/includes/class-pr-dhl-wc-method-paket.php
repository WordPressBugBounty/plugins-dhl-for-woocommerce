	...
	class PR_DHL_WC_Method_Paket extends WC_Shipping_Method {
		...
		public function init_form_fields() {
			...
			$this->form_fields += array(
				...
				'dhl_default_one_time_code'         => array(
					'title'       => esc_html__( 'One-Time Code default', 'dhl-for-woocommerce' ),
					'type'        => 'checkbox',
					'label'       => esc_html__( 'Checked', 'dhl-for-woocommerce' ),
					'default'     => 'no',
					'description' => esc_html__( 'Please, tick here if you want the "One-Time Code" option to be checked in the "Edit Order" before printing a label.', 'dhl-for-woocommerce' ),
					'desc_tip'    => true,
				),
				'dhl_default_second_delivery_attempt' => array(
					'title'       => esc_html__( 'Second Delivery Attempt default', 'dhl-for-woocommerce' ),
					'type'        => 'checkbox',
					'label'       => esc_html__( 'Checked', 'dhl-for-woocommerce' ),
					'default'     => 'no',
					'description' => esc_html__( 'Please, tick here if you want the "Second Delivery Attempt" option to be checked in the "Edit Order" before printing a label.', 'dhl-for-woocommerce' ),
					'desc_tip'    => true,
				),
				'dhl_default_no_packstation'        => array(
					'title'       => esc_html__( 'No Parcel Locker default', 'dhl-for-woocommerce' ),
					'type'        => 'checkbox',
					'label'       => esc_html__( 'Checked', 'dhl-for-woocommerce' ),
					'default'     => 'no',
					'description' => esc_html__( 'Please, tick here if you want the "No Parcel Locker" option to be checked in the "Edit Order" before printing a label.', 'dhl-for-woocommerce' ),
					'desc_tip'    => true,
				),
				'dhl_default_immediate_return'      => array(
					'title'       => esc_html__( 'Immediate Return default', 'dhl-for-woocommerce' ),
					'type'        => 'checkbox',
					'label'       => esc_html__( 'Checked', 'dhl-for-woocommerce' ),
					'default'     => 'no',
					'description' => esc_html__( 'Please, tick here if you want the "Immediate Return" option to be checked in the "Edit Order" before printing a label.', 'dhl-for-woocommerce' ),
					'desc_tip'    => true,
				),
